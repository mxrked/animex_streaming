...
const SEINEN_SERIES = [VINLAND_SAGA_OBJ, OPM_OBJ];
const COMEDY_SERIES = [JOJO_OBJ, OPM_OBJ, SXF_OBJ];
const ROMANCE_SERIES = [SXF_OBJ, MOB_PSYCHO_OBJ];
const FANTASY_SERIES = [DEMON_SLAYER_OBJ, JOJO_OBJ];
const HORROR_SERIES = [AOT_OBJ, DEMON_SLAYER_OBJ, CSM_OBJ];
const ALPHABETICAL_SERIES = ALL_SERIES.sort((a, b) =>
